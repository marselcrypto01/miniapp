    ...
    (async () => {
      try {
        ...
        setLessons([
          ...
          { id: 3, title: 'Риски и страхи: как купить свою первую крипту' },
      ...
      <section className="w-full">
        ...
        <div className="w-full p-4 rounded-2xl bg-[var(--surface)] border border-[var(--border)]">
          <div className="grid grid-cols-[48px_1fr] gap-3 w-full">
            ...
            >
              {(allCompleted || points >= 500) ? 'Открыть' : 'Требуется 500 очков'}
            </button>
        ...
        <div className="space-y-2">
          {[
            ...
            [
              ...
              '👉 Достаточно 2–3 часов в день. Этого хватает, чтобы делать сделки и зарабатывать. Арбитраж легко совмещать с работой или учёбой.',
            ],
            [
