    ...
    <main className={`${WRAP} py-4`}>
      ...
      <section className="w-full mt-6">
        ...
        <div className="space-y-2">
          ...
          <details className="glass rounded-2xl p-3 w-full">
            <summary className="cursor-pointer font-semibold">
              Нужно ли показывать доход налоговой или бояться блокировок?
            </summary>
            <p className="mt-2 text-sm text-[var(--muted)]">
          ...
          <details className="glass rounded-2xl p-3 w-full">
            <summary className="cursor-pointer font-semibold">
              А если у меня нет подходящей карты/банка?
            </summary>
            <p className="mt-2 text-sm text-[var(--muted)]">
          ...
          <details className="glass rounded-2xl p-3 w-full">
            <summary className="cursor-pointer font-semibold">
              А если курс закроют или крипту запретят?
            </summary>
            <p className="mt-2 text-sm text-[var(--muted)]">
          ...
          <details className="glass rounded-2xl p-3 w-full">
            <summary className="cursor-pointer font-semibold">
              Нужно ли сидеть за компьютером весь день?
            </summary>
            <p className="mt-2 text-sm text-[var(--muted)]">
